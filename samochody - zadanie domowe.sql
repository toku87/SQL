...
#select a.idauta, a.marka, a.model from auta as a , wypozyczenia as w
#where a.idauta= w.idauta and w.datawyp order by w.datawyp asc limit 1 ;

#select k.imie, k.nazwisko from klienci as k, wypozyczenia as w where
#w.idauta=1 and k.idklienta=w.idklienta ;

#select a.marka, a.model from auta as a, wypozyczenia as w
#where w.idklienta=4 and a.idauta=w.idauta;

#select a.marka, a.model from auta as a, klienci as k, wypozyczenia as w
#where k.nazwisko="pastewniak" and k.idklienta=w.idklienta and a.idauta = w.idauta;
