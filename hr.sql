...
select e.first_name, e.last_name, d.department_name, l.state_province, l.city from employees as e 
left join departments as d on e.department_id=d.department_id join locations as l on l.location_id=d.location_id;

select e.first_name, e.last_name, e.department_id, d.department_name from employees as e join departments d 
on e.department_id = d.department_id where d.department_id = 40 or d.department_id=80;

select e.first_name, e.last_name, d.department_name, l.city, l.state_province from employees as e join departments as d 
on e.department_id=d.department_id join locations as l on d.location_id=l.location_id where e.first_name like "%z%"; 
#6
select d.department_name, e.* from employees as e left join departments as d on e.department_id=d.department_id;
#7
...
join departments d using (department_id) join employees e using (employee_id) where jh.start_date >= "1993-01-01" and jh.start_date <= "1997-07-31";
